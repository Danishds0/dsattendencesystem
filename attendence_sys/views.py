...
def registerPage(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            fac = Faculty()
            fac.firstname = request.POST['firstname']
            fac.lastname = request.POST['lastname']
            fac.email = request.POST['email']
            fac.phone = request.POST['phone']
            fac.user = User.objects.get(username = request.POST['username'])
            fac.save()
